...
export default function MyComponent() {
    ...
    const handleClickanalysis = async () => {
            ...
            const response = await fetch(`http://127.0.0.1:8000/analysis/${usrName}`, {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json'
                },
        ...
        <div className="text-center">
            ...
            <div className="text-center flex">
                ...
                <div className="join m-8">
                    <textarea className="textarea textarea-primary w-full max-w-xs m-8" type="text" value={inputText}
                              onChange={(e) => setInputText(e.target.value)}/>
                    <button className="btn btn-primary m-8" onClick={handleClick}>Predict Emotion</button>
                    <button className="btn btn-primary m-8" onClick={handleClickanalysis}>Get Average Analysis</button>
                </div>
